...
import { ShoppingCart, Pets, People, Close as CloseIcon } from '@mui/icons-material';
import PaymentPopup from './PaymentPopUp'; // Importamos el nuevo componente
...
const DetailedViewProvider = ({ selectedProvider }) => {
  ...
  const [paymentPopupOpen, setPaymentPopupOpen] = useState(false); // Estado para el Pop-Up final
