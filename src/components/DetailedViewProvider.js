...
const DetailedViewProvider = ({selectedProvider}) => {
  console.log('hola',selectedProvider)
  ...
  const handleAccept = () => {
    ...
    return (
        ...
        <Typography variant="body2" sx={{ mb: 2 }}>{selectedProvider.direccion.localidad}</Typography>
        <Typography variant="body1" sx={{ mb: 2, textAlign: 'center' }}>{selectedProvider.descripcion}</Typography>
